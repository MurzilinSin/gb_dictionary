...
import com.example.gb_coroutinekoin.databinding.LayoutLoadBinding
...
import com.example.gb_coroutinekoin.viewmodels.BaseViewModel

private const val DIALOG_FRAGMENT_TAG = "74a54328-5d62-46bf-ab6b-cbf5d8c79522"

abstract class BaseActivity<T : AppState, I : Interactor<T>> : AppCompatActivity() {

    private lateinit var binding: LayoutLoadBinding
    ...
    override fun onResume() {
        super.onResume()
        binding = LayoutLoadBinding.inflate(layoutInflater)
